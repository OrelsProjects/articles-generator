...
Ever had a staring contest with a blank page? (Spoiler: The page always wins.) Well, say goodbye to those 20 rewrites—I created WriteRoom, an AI sidekick for humans who write, not R2-D2's diary..
`,
...
That's why I created WriteRoom—an AI-powered text editor made for writers, not robots. It's built to break through blocks and spark creativity, just like we need.`,
  Sarcastic: `Hey there! 🙄

I'm Orel, running The Indiepreneur on Substack because apparently, the world needed another newsletter (lucky you!).

Oh, you know that delightful writer's block? I fixed it with WriteRoom—an AI-powered editor because clearly, what writers need is more AI in their lives.`,
};
