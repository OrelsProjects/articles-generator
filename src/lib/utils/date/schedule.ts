import { format, getMonth, getYear, getDate, addMinutes, isAfter } from "date-fns";
...
export const getScheduleTimeText = (scheduledDate: Date, includeText: boolean = true): string => {
...
export const isValidScheduleTime = (scheduledDate: Date | undefined): boolean => {
